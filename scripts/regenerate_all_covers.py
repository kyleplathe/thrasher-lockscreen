#!/usr/bin/env python3
"""
Regenerate All Covers with Final Layout
Reads shortcuts_text_overlay_covers.json and regenerates all 550 covers
using the final perfected layout with bold dates and centered text
"""
...
class CoverRegenerator:
    def __init__(self):
        self.json_file = "shortcuts_text_overlay_covers.json"
        self.output_dir = "images/optimized_final_with_text"
        self.original_dir = "images/original"  # Use original images without text overlays
    ...
    def regenerate_all(self):
        ...
        print("🚀 Regenerating all 550 covers with final layout...")
        print("   Using: bold dates, centered text below badge, tight spacing")
        print()
        ...
        for i, image_data in enumerate(images_data):
            ...
            # Create the overlay
            output_path = self.create_text_overlay(original_path, metadata)
            if output_path:
                processed_count += 1
            else:
                failed_count += 1
...
def main():
    regenerator = CoverRegenerator()
    regenerator.regenerate_all()
    
    print()
    print("🎨 All covers regenerated with final layout!")
