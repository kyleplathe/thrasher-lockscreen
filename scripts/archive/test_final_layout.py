...
"""
Final Layout Test
- Date bold and at fixed position (like 3-line example)
- Badge gap
- Tighter spacing between bottom lines
- Consistent layout for all line counts
"""
...
class FinalLayoutTester:
    ...
    def create_layout(self, test_data):
        ...
        try:
            ...
            # FIXED POSITIONING (based on 3-line example)
            # Date position is fixed, regardless of line count
            date_y = 2228  # Fixed position like 3-line example
            ...
            # Save
            output_filename = f"final_{expected_lines}line_{filename}"
    ...
    def run_tests(self):
        ...
        print("   - Date: Bold, fixed position Y=2228")
        print("   - Badge gap: 80px")
        print("   - Skater: +2px from normal (move down)")
        print("   - Tight spacing: 20px (all lines below badge centered)")
        print("━" * 70)
        print()
        ...
        print()
        print("✅ Final layout tests complete!")
        print(f"📁 Output: {self.output_dir}/")

if __name__ == "__main__":
    tester = FinalLayoutTester()
    tester.run_tests()
